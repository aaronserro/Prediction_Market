    ...
    <div className="min-h-screen bg-slate-950 pt-20 pb-16 flex items-center justify-center">
      ...
      >
        ...
        <p className="text-lg text-slate-400 max-w-md mx-auto">
          The News & Updates feature is currently under construction. We're working hard to bring you the latest market insights and platform updates. Check back soon!
        </p>
      </motion.div>
    </div>
  );
